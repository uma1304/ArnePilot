...
class WayCollection():
  ...
  def get_route(self, location_rad, bearing_rad):
    """Provides the best route found in the way collection based on provided `location_rad` and `bearing_rad`
    """
    if location_rad is None or bearing_rad is None:
      return None
