...
class Controls:
  def __init__(self, sm=None, pm=None, can_sock=None):
    ...
    self.sm = sm
    if self.sm is None:
      ignore = ['ubloxRaw', 'driverCameraState', 'managerState', 'dragonConf'] if SIMULATION or travis else ['ubloxRaw', 'dragonConf']
      ...
      self.sm = messaging.SubMaster(['deviceState', 'pandaState', 'modelV2', 'liveCalibration', 'ubloxRaw',
                                     ...
                                     'roadCameraState', 'driverCameraState', 'managerState', 'liveParameters', 'radarState', 'dragonConf', 'testJoystick'], ignore_alive=ignore)
  ...
  def publish_logs(self, CS, start_time, actuators, v_acc, a_acc, lac_log):
    ...
    controlsState.decelForTurn = self.sm['longitudinalPlan'].decelForTurn
