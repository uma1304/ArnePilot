...
class DynamicGas:
  ...
  def set_profile(self):
    self.x_lead_mod_y = [1.0, 0.8, 0.0] # as lead gets further from car, lessen gas mod/reduction
    ...
    if self.dp_profile == DP_ECO:
      ...
      y = [0.38, 0.40, 0.38, 0.33, 0.33, 0.32, 0.31, 0.30, 0.27, 0.25, 0.24, 0.24, 0.23, 0.22, 0.22, 0.21, 0.20, 0.20]
      ...
      self.x_lead_mod_x = [6.1, 9.15, 15.24]
