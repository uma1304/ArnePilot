...
def thermald_thread():
  ...
  while 1:
    ...
    if max_cpu_temp > 107. or bat_temp >= 63. or ((health is not None and health.health.hwType != log.HealthData.HwType.greyPanda) and is_offroad_for_5_min and max_cpu_temp > 70.0):
      # onroad not allowed
